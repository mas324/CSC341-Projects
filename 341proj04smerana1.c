...
int main (int argc, char ** argv)  {
    ...
    for (i = 0; i < _THREAD_MAX; i++) { // Fill out thread array
...
char * thread_error ( int error )  {
    switch (error)  {
        ...
        //case EINVAL: return "The th thread has been detached.";
        //case EDEADLK: return "The th argument refers to the calling thread."; 
        //case EAGAIN:  return "not enough system resources to create /
